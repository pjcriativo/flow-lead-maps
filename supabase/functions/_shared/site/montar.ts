...
// O design é 100% do template; só o conteúdo (copy) varia. Nunca degrada.
...
export function montarHtml(mp: MateriaPrima, conteudo: ConteudoIA, nicho: TemplateId): string {
  const d = montarSiteData(mp, conteudo, nicho);
  switch (nicho) {
    case "saude":
