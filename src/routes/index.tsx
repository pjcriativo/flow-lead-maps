      ...
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          <nav className="hidden items-center gap-8 text-sm font-medium text-slate-600 md:flex">
            <a href="#dor" className="hover:text-primary transition-colors">
              A Realidade
            </a>
          ...
          <div className="flex items-center gap-4">
            <Link
              ...
              search={{ mode: "signin" }}
              preload="render"
              className="hidden text-sm font-medium text-slate-600 hover:text-primary sm:block"
            >
              Acessar Painel
            </Link>
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="text-balance text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl md:text-6xl leading-tight">
              Se você continua caçando leads na mão, seu negócio está com os{" "}
              <br className="hidden md:block" />
              <span className="text-primary">dias contados.</span>
            </h1>

            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-600 font-medium">
              O mercado engoliu quem perde 80% do dia copiando e colando e-mails frios. Extraia,
              qualifique e feche negócios automaticamente com a única ferramenta desenhada para
              faturar <strong className="text-slate-900">R$ 3.500+ líquidos</strong> sem depender da
              sorte.
            </p>
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link to="/pricing" preload="render" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full h-14 px-8 text-base font-bold shadow-md transition-transform hover:scale-105"
                >
              ...
              <a href="#solucao" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full h-14 px-8 text-base font-medium border-slate-300 text-slate-700 bg-white hover:bg-slate-50 transition-colors"
                >
                  Entender a Máquina
                </Button>
              </a>
            ...
            <p className="mt-6 text-sm text-slate-500 flex items-center justify-center gap-2">
              <ShieldCheck className="h-4 w-4 text-primary" /> Setup Imediato · Escalabilidade
              Absoluta
            </p>
          </div>
        </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 text-lg text-slate-600 leading-relaxed font-medium">
                Você vende a ideia de liberdade corporativa, mas passa 12 horas por dia com os olhos
                vermelhos rastreando o LinkedIn e o Google Maps em busca de decisores que nunca te
                respondem.
              </p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-slate-600">
                      Comprar listas de emails vazados só serve para destruir a reputação do seu
                      domínio. Seus e-mails caem direto no SPAM.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-slate-900">
                      Gestão amadora e perda de dinheiro
                    </h4>
                    <p className="mt-1 text-slate-600">
                      Esquecer de fazer o follow-up porque anotou o número do cliente num bloco de
                      notas. O dinheiro escapa pelos seus dedos.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative rounded-2xl bg-slate-50 border border-slate-200 p-8 md:p-10 shadow-sm">
              ...
              <ul className="mt-8 space-y-5">
                {[
                  ...
                  <li
                    key={idx}
                    className="flex items-start gap-4 text-slate-700 font-medium text-base"
                  >
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              >
                <div
                  className={`flex h-14 w-14 items-center justify-center rounded-xl border ${f.bg} ${f.color} mb-6`}
                >
          ...
          <div className="grid gap-16 md:grid-cols-3 relative">
            ...
            {[
              ...
              <div key={s.step} className="flex flex-col items-center text-center">
                ...
                <p className="mt-3 text-base text-slate-600 leading-relaxed max-w-[280px] font-medium">
                  {s.desc}
                </p>
              </div>
            ))}
      ...
      <section className="py-32 relative bg-primary overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-6 text-center relative z-10">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-xl text-primary-foreground/90 font-medium leading-relaxed">
            Agências e SDRs de elite já abandonaram o amadorismo. Quem não tem uma máquina de
            prospecção hoje, amanhã estará pedindo emprego no LinkedIn. Você vai agir ou vai ser
            engolido?
          </p>
          ...
          <div className="mt-8 flex justify-center gap-8 text-sm font-bold text-primary-foreground/80">
            <span className="flex items-center gap-2">
              <CheckCircle2 className="h-5 w-5" /> Setup imediato
            </span>
            <span className="flex items-center gap-2">
              <CheckCircle2 className="h-5 w-5" /> Cancele quando quiser
            </span>
          </div>
        </div>
      </section>
