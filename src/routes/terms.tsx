        ...
        <section className="mt-10 space-y-6 text-sm leading-relaxed text-muted-foreground">
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              todas as atividades realizadas por meio dela. Notifique-nos imediatamente em caso de
              uso não autorizado.
            </p>
          </div>
          ...
          <div>
            <h2 className="text-lg font-semibold text-foreground">
              5. Responsabilidade sobre os Dados de Leads (LGPD)
            </h2>
            <p className="mt-2">
            ...
            <p className="mt-2">
              ...
              <strong>base legal adequada</strong> (por exemplo, legítimo interesse, nos termos dos
              arts. 7º e 10 da LGPD) para tratar os dados dos leads; (b) atender às requisições dos
          ...
          <div>
            ...
            <p className="mt-2">
              Os planos pagos são renovados automaticamente até o cancelamento. Você pode cancelar a
              qualquer momento pela sua conta; o cancelamento passa a valer ao fim do período de
              cobrança vigente. Reembolsos observam a nossa{" "}
              <Link to="/refund" className="text-primary">
                Política de Reembolso
              </Link>{" "}
              e o direito de arrependimento do art. 49 do CDC.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-semibold text-foreground">
              7. Precisão dos Dados de Leads
            </h2>
            <p className="mt-2">
              Os dados de leads são obtidos de plataformas de terceiros e fornecidos "no estado em
              que se encontram". Não garantimos exatidão, completude ou adequação a qualquer
          ...
          <div>
            ...
            <p className="mt-2">
              Podemos suspender ou encerrar o seu acesso caso você descumpra estes Termos ou utilize
              o Serviço de forma que gere risco a nós ou a outros usuários.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              Podemos atualizar estes Termos periodicamente. O uso continuado do Serviço após a
              publicação das alterações representa a aceitação da versão revisada.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              foro do domicílio do consumidor para dirimir quaisquer controvérsias, nos termos do
              CDC.
            </p>
          </div>
