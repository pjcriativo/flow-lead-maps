...
> ⚠️ **REQUER ADAPTAÇÃO: endpoints/payloads da Evolution GO podem diferir — validar contra a doc da Evolution Go antes de usar.**
> (Este projeto usa **Evolution GO** (Go), não a Evolution API Node desta skill.)
